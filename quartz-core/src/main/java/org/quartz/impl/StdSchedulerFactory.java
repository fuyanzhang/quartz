...
import org.quartz.impl.zkjobstore.JobZkStoreSupport;
...
public class StdSchedulerFactory implements SchedulerFactory {
    ...
    public static final String PROP_ZOOKEEPER_URL = "org.quartz.zookeeper.URL";

    public static final String PROP_ZOOKEEPER_RETRYPOLICY = "org.quartz.zookeeper.retryPolicy";

    public static final String PROP_ZOOKEEPER_SESSIONTIMEOUT = "org.quartz.zookeeper.sessionTimeout";

    public static final String PROP_ZOOKEEPER_NAMESPACE = "org.quartz.zookeeper.namespace";
    /**
    ...
    private Scheduler instantiate() throws SchedulerException {
        ...
        try {
            ...
            } else if (js instanceof JobZkStoreSupport) {
                JobZkStoreSupport jzss = (JobZkStoreSupport) js;
                jzss.setThreadExecutor(threadExecutor);
            }
